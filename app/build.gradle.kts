...
android {
    namespace = "com.gatotote.descargador"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.gatotote.descargador"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "0.1.0"

        // youtubedl-android trae binarios nativos (Python, FFmpeg) por ABI.
        ndk {
    ...
    // youtubedl-android: no comprimir sus binarios dentro del APK.
    packaging {
        jniLibs {
